...
```
git clone https://github.com/helenabatiista/testes-automatizados-e2e-front-serve-rest_cypress.git
```

- Ou informar o comando abaixo para clonar este repositório via "SSH"

```
git clone git@github.com:helenabatiista/testes-automatizados-e2e-front-serve-rest_cypress.git
```
